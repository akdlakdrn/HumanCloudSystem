...
<body>
    ...
    <div class="my_container">
            <form action="/companyresume/create" method="post" enctype="multipart/form-data" name="myForm">
        ...
        <div>
            ...
            <div class="my_menu">
                ...
                <div class="filebox"> <label for="ex_file">회사 이미지 등록</label> <input type="file" id="ex_file" name="file" required="required" /> </div>
