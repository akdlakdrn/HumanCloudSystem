        ...
        <div class="row">
          <div class="input-field col s12">
            <input id="applicantId" name="username" type="text"
              class="validate" value = "kangcom"> <label for="applicantId">아이디</label>
          </div>
        </div>
        <div class="row">
          <div class="input-field col s12">
            <input id="pw1" type="password" name="password" class="validate " value = "kangcom"/>
